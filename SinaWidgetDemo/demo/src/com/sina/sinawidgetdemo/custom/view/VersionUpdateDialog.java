	...
	public static class Builder {
		...
		public VersionUpdateDialog create() {
			...
			if (positiveButtonText != null) {
				((Button) layout.findViewById(R.id.btn_dialog_confirm))
				...
				layout.findViewById(R.id.btn_dialog_confirm).setVisibility(
						View.GONE);
			}
			...
			TextView newVersionTv =  (TextView) layout.findViewById(R.id.updatetip_new_version);
			if(newVersion != null){
				newVersionTv.setText("V"+newVersion);
			}
			else{
				newVersionTv.setVisibility(View.GONE);
			}
			// set the content message
			if (message != null) {
				((TextView) layout.findViewById(R.id.tv_dialog_text))
						.setText(message);
			} else if (contentView != null) {
				// if no message set
				// add the contentView to the dialog body
				((LinearLayout) layout.findViewById(R.id.tv_dialog_text))
						.removeAllViews();
				((LinearLayout) layout.findViewById(R.id.tv_dialog_text))
