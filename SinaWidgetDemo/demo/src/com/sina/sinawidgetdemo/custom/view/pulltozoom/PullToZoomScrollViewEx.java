package com.sina.sinawidgetdemo.custom.view.pulltozoom;
...
//        mRootContainer.setOrientation(LinearLayout.VERTICAL);
        ...
        mHeaderContainer.setId(10101010);
        if (mZoomView != null) {
            mHeaderContainer.addView(mZoomView);
        }
        if (mHeaderView != null) {
        ...
        if (contentViewResId > 0) {
         ...
         mRootContainer.addView(mHeaderContainer, new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT));
        RelativeLayout.LayoutParams lp = new android.widget.RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lp.addRule(RelativeLayout.BELOW, 10101010);
