...
public class BannerLayout extends LinearLayout {
	...
	private BannerGalleryContainer container;
...
//	}
	...
	public void init(Context context, List<JumpableImage> mFocusImageList) {
		View view = LayoutInflater.from(context).inflate(R.layout.banner_layout,
				null);
		container = (BannerGalleryContainer) view.findViewById(R.id.banner_container);
		gallery = (BannerGallery) view.findViewById(R.id.banner_gallery);
