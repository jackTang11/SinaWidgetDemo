...
public class TabTextChangeIndicator extends HorizontalScrollView {
    ...
    public TabTextChangeIndicator(Context context) {
        this(context, null);
    }

    public TabTextChangeIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabTextChangeIndicator(Context context, AttributeSet attrs, int defStyle) {
