...
import com.sina.sinawidgetdemo.custom.horizontalvariablelistview.ViewHelperFactory.ViewHelper;
...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements
	...
	public AbsHListView(Context context, AttributeSet attrs) {
		...
		// "sephiroth_absHListViewStyle", "attr", context.getPackageName() ) );
	...
	public AbsHListView(Context context, AttributeSet attrs, int defStyle) {
		...
		if (null != styleableArray) {
			array = context.obtainStyledAttributes(attrs, styleableArray,
					defStyle, 0);
		}
		...
		if (null != array) {
			...
			listSelector = array.getDrawable(0 /*
												 ...
												 * AbsHListView_android_listSelector
												 */);
			drawSelectorOnTop = array.getBoolean(1 /*
													 * R.styleable.
													 * AbsHListView_android_drawSelectorOnTop
													 */, false);
			stackFromRight = array.getBoolean(6 /*
												 * R.styleable.
												 * AbsHListView_stackFromRight
												 */, false);
			scrollingCacheEnabled = array.getBoolean(2 /*
														 * R.styleable.
														 * AbsHListView_android_scrollingCache
														 */, true);
			transcriptMode = array.getInt(7 /*
											 * R.styleable.
											 * AbsHListView_transcriptMode
											 */, TRANSCRIPT_MODE_DISABLED);
			color = array.getColor(3 /*
									 * R.styleable.
									 * AbsHListView_android_cacheColorHint
									 */, 0);
			smoothScrollbar = array.getBoolean(5 /*
												 * R.styleable.
												 * AbsHListView_android_smoothScrollbar
												 */, true);
			choiceMode = array.getInt(4 /*
										 * R.styleable.
										 * AbsHListView_android_choiceMode
	...
	protected float getHorizontalScrollFactor() {
		if (mHorizontalScrollFactor == 0) {
			...
			// "sephiroth_listPreferredItemWidth", "attr",
			// getContext().getPackageName());
			int resId = R.attr.sephiroth_listPreferredItemWidth;
			...
			if (resId != 0) {
				...
				if (success) {
					mHorizontalScrollFactor = outValue
							.getDimension(getContext().getResources()
									.getDisplayMetrics());
				} else {
					throw new IllegalStateException(
							"Expected theme to define sephiroth_listPreferredItemWidth.");
				}
			} else {
				throw new IllegalStateException(
						"Expected theme to define sephiroth_listPreferredItemWidth.");
	...
	public static final <T> T getFieldFromStyleable(Context context, String name) {
		try {
			...
			Field field = Class.forName(
					context.getPackageName() + ".R$styleable").getField(name);
			if (null != field) {
