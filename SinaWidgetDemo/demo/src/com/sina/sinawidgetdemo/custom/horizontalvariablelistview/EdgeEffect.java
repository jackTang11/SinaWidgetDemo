...
public class EdgeEffect {
	...
	public EdgeEffect(Context context, int direction) {
		...
		// int resId = res.getIdentifier("hlv_overscroll_edge", "drawable",
		// context.getPackageName());
		int resId = R.drawable.hlv_overscroll_edge;
		if (resId > 0) {
			mEdge = res.getDrawable(resId);
		} else {
			throw new IllegalStateException(
					"Cannot find resource 'hlv_overscroll_edge'");
		}

		// resId = res.getIdentifier("hlv_overscroll_glow", "drawable",
		// context.getPackageName());
		resId = R.drawable.hlv_overscroll_glow;
		if (resId > 0) {
			mGlow = res.getDrawable(resId);
		} else {
			throw new IllegalStateException(
					"Cannot find resource 'hlv_overscroll_glow'");
		}
